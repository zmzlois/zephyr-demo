    ...
    <div className="container mx-auto px-4 mt-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="relative">
          <input
            type="text"
            className="p-2 rounded text-lg border border-gray-300 bg-white dark:bg-gray-700 dark:text-white w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <select
          className="p-2 rounded text-lg border border-gray-300 bg-white dark:bg-gray-700 dark:text-white w-full focus:outline-none focus:ring-2 focus:ring-blue-500 theme-dropdown"
          value={searchSize}
